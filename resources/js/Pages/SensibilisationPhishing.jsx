...
import { AlertTriangle } from "lucide-react"; // Icône d'alerte moderne
...
export default function SensibilisationPhishing() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-red-200 to-red-600 dark:from-gray-900 dark:to-gray-800 p-6">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-10 max-w-lg text-center border-4 border-red-600 animate-fadeIn">
        ...
        <div className="bg-red-100 dark:bg-red-800 text-red-800 dark:text-red-100 p-4 rounded-lg mb-6">
        ...
        <button
          ...
          className="bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 mb-6 transition shadow-lg"
        >
          {showTips ? "Masquer les conseils" : "Comment se protéger ?"}
        </button>

        {/* Conseils affichés */}
        {showTips && (
          <div className="bg-gray-100 dark:bg-green-700 rounded-lg p-4 text-left mb-6 animate-fadeIn">
            <h2 className="font-semibold text-green-800 dark:text-gray-100 mb-2">Bonnes pratiques :</h2>
